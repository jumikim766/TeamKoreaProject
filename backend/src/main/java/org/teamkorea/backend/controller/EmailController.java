...
public class EmailController {
        ...
        public ResponseEntity<BaseResponse<Map<String, Object>>> getEmails(
                        ...
                        @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime receivedAtFrom,
                        @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime receivedAtTo,
                ...
                Page<EmailListResponseDto> emailPage = emailService.getEmails(userId, accountId, keyword,
                                receivedAtFrom, receivedAtTo, page, size);
